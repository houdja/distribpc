...
include("C:/xampp/htdocs/distribpc/webadmin/modules/data_dashboard/promotion/requete_produit.php");
?>
...
<?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
    ...
    for ($i = 1; $i <= $nombreDePages; $i++) //On fait notre boucle
    {
        ...
        {
            echo ' <a href="http://localhost/distribpc/webadmin/modules/data_dashboard/data_details/promotion.php?page=' . $i . '">' . $i  . '</a> ';
        }
    }
    echo '</p>';
