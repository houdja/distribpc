...
include("C:/xampp/htdocs/distribpc/webadmin/modules/data_dashboard/nombre_peripheriques/requete.php");
?>
...
<div class="card">
    ...
    <button><a href="http://localhost/distribpc/webadmin/modules/data_dashboard/data_details/peripherique.php">Plus de details</a></button>
</div>